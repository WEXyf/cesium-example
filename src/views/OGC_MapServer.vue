...
onMounted(async () => {
    try {
        ...
        // WMS - 单张图片
        var geoWMS = new Cesium.WebMapServiceImageryProvider({
        ...
        viewer.imageryLayers.addImageryProvider(geoWMS);
        setTimeout(() => {
            viewer.camera.flyTo({
                destination: Cesium.Cartesian3.fromDegrees(146.4175, -42.655, 5000),
                orientation: {
